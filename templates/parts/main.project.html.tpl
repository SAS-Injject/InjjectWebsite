<section class="w-100 section-margin section-padding bg-main-light">
  <h2 class="title-main-dark text-center">Votre projet de A à Z</h2>
  <div class="project-step-container">
    <div class="project-step">
      <h3 class="title-sub-dark">
    ...
    <div class="project-step">
      ...
      <p class="main-paragraph">Après l'installation et la mise en service de votre projet, nous prenons le temps de 
        vous expliquer en détails le fonctionnement de votre nouvelle solution, veillant à ce que vous soyez à l'aise 
        avec son utilisation.</p>
    </div>
  </div>
</section>